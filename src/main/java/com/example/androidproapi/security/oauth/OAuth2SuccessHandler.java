...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    public OAuth2SuccessHandler(TokenProvider tokenProvider, RefreshTokenRepository refreshTokenRepository, OAuth2AuthorizationRequestBasedOnCookieRepository authorizationRequestRepository, UserService userService) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        User user = userService.findByAccount((String) oAuth2User.getAttributes().get("account"));
